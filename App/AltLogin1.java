...
public class AltLogin1 extends JFrame {
	...
	public AltLogin1() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String coderusr = "daniel";
				String coderpass = "1234";
				...
				for (int i = 0; i<= 8; i++) {
					...
					else if (inputusr.equals(coderusr) && usrpass.equals(coderpass)) {
						dispose();
						CoderPage1 coderp = new CoderPage1();
						coderp.setVisible(true);
						break;
					}
